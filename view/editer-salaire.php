<?php
	...
	require_once '../model/edit-salaire.php';
?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="panel-body">
			...
			?>
			  ...
			  <div class="form-group">
					...
					<input type="number" name="nbre_prest" required="required" class="form-control" value="<?= $userinfo['nbre_prest'] ?>">
			  </div>
			  <div class="form-group">
					<label class="control-label">
						SAL JOURNALIER ($):
					</label>
					<input type="number" name="sal_journ" required="required" class="form-control" value="<?= $userinfo['sal_journ'] ?>">
			  </div>
			  <div class="form-group">
					<label class="control-label">
						Soin Médicaux(%):
					</label>
					<input type="number" name="soinmed" required="required" class="form-control" value="<?= $userinfo['soinmed'] ?>">
			  </div>
